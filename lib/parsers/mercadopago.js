...
//
// ─── Argentina, resumo de cartão: MORA EM OUTRO ARQUIVO ──────────────────────
// Ver lib/parsers/resumen-tarjeta-ar.js. Este arquivo chegou a ter um layout
// AR.invoice inventado por analogia com o brasileiro; o documento real não se
// parece com ele em nada, e a suposição foi removida em vez de mantida "por
// via das dúvidas".
...
const LAYOUTS = {
  ...
  AR: {
    ...
    // invoice: REMOVIDO na v4.3.3.
    //
    // Havia aqui um layout de resumo de cartão argentino que era pura
    // suposição — o layout brasileiro traduzido palavra por palavra
    // ("Movimientos del resumen", "Tarjeta X [", "Cuota N de M"). Quando um
    // resumo real apareceu, nenhum desses marcadores existia: a tabela é
    // colada sem separador, as datas não têm ano e há duas moedas na mesma
    // coluna. O documento real é lido por lib/parsers/resumen-tarjeta-ar.js.
    //
    // Preferi apagar a suposição a deixá-la de reserva: código que nunca casa
    // com nada só serve para dar a impressão de que o caso está coberto.
  },
};
