...
const KEYWORDS_AR = [
  ...
  // Delivery e comida
  { kw: ['rappi', 'pedidosya', 'pedidos ya', 'mostaza', 'grido', 'kiosco', 'panaderia', 'rotiseria', 'restaurante', 'parrilla', 'cafe ', 'mcdonald', 'burger king', 'starbucks'], cat: CAT.FOOD },
  ...
  { kw: ['impuesto al debito', 'impuesto al credito', 'ley 25413', 'percepcion', 'retencion', 'iva ', 'iibb', 'ingresos brutos', 'sellado', 'impuesto al sello', 'interes', 'intereses', 'comision', 'mantenimiento de cuenta', 'seguro', 'prestamo', 'monotributo', 'imp. afip', 'imp afip', /\barca\b/], cat: CAT.FINANCIAL },
