...
export default {
  ...
  'health.help': 'Indicadores del mes actual, con valores y pendientes que requieren atención.',
  'health.monthBalance': 'Resultado del mes',
  'health.balancePositive': 'Los ingresos cubren los gastos registrados.',
  'health.balanceNegative': 'Los gastos superan los ingresos registrados.',
  'health.dailyBudget': 'Margen por día',
  'health.dailyBudgetHelp': 'para los próximos {n} días',
  'health.commitments': 'Próximas cuotas',
  'health.commitmentsHelp': '{n} cuota(s) prevista(s) en {month}',
  'health.pending': 'Pendientes',
  'health.overdue': '{n} cuenta(s) vencida(s)',
  'health.noOverdue': 'Sin cuentas vencidas',
  'health.toReview': '{n} movimiento(s) todavía requieren categoría.',
  'health.reviewClear': 'No hay movimientos esperando revisión.',
