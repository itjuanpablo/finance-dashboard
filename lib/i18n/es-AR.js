...
export default {
  ...
  'import.dropzoneHint': 'OFX y CSV de cualquier banco · PDF de los bancos ya reconocidos',
  ...
  'import.hintPrefix': 'OFX y CSV de cualquier banco, PDF de los ya reconocidos — o ',
  ...
  'import.err.corrupt':
    ...
    'algunas exportaciones de banco). Generá el PDF de nuevo desde la app o la web del banco; ' +
    'si sigue igual, convertilo a CSV (columnas: fecha;descripcion;importe) e importá el CSV.',
  'import.err.unknownPdf':
    'No reconozco el formato de este PDF. Hoy Fluxo lee PDF de: Mercado Pago (extracto y ' +
    'resumen), cuentas argentinas, Nubank (extracto) e Inter (Cuenta Global). Para los demás ' +
    'bancos, usá OFX o CSV — andan con cualquier banco y suelen traer el signo del ' +
  ...
  'dash.nextSteps': 'Próximos pasos',
  'dash.nextStepsHelp': 'Revisá lo que necesita atención este mes.',
  'dash.monthlyReview': 'Cerrar el mes',
  'dash.monthlyReviewHelp': 'Resolvé lo pendiente que todavía puede cambiar tu lectura del mes.',
  'dash.monthlyCategorize': 'Categorizar movimientos',
  'dash.monthlyOpen': 'Revisar ahora',
  'dash.monthlyClear': 'Todo está al día este mes.',
  ...
  'manage.accNamePh': 'Nombre (ej: Caja de ahorro)',
  ...
  // subcategorías (ver lib/arvore-categorias.js)
  'manage.parentLabel': 'Dentro de',
  'manage.parentNone': '— categoría principal —',
  'manage.parentNotFound': 'La categoría madre elegida no existe.',
  'manage.parentSelf': 'Una categoría no puede estar dentro de sí misma.',
  'manage.parentTooDeep': 'Solo un nivel: esa ya está dentro de otra.',
  'manage.parentHasKids': 'Esa categoría ya tiene subcategorías — no puede volverse subcategoría.',
  'manage.parentSystem': 'Las categorías del sistema quedan fuera de la jerarquía.',
  'manage.subCount.one': '{n} subcategoría',
  'manage.subCount.other': '{n} subcategorías',
  'manage.catOrphaned.one': '{n} subcategoría pasó a ser categoría principal',
  'manage.catOrphaned.other': '{n} subcategorías pasaron a ser categorías principales',
  'manage.withSubs': 'incluye subcategorías',
  ...
  // pago del resumen (ver lib/quitacao.js)
  'cards.settleManual': 'Marcar como pagado',
  'cards.settleFound': 'Encontré un pago que parece ser de este resumen',
  'cards.settleConfirm': 'Confirmar pago',
  'cards.settledOn': '{v} el {d}',
  'cards.unsettle': 'Deshacer',
  'cards.settledOk': 'Resumen marcado como pagado',
  'cards.unsettledOk': 'Pago deshecho',
  'cards.settleTxTaken': 'Ese movimiento ya paga otro resumen.',
  ...
  // ── revisión en masa ───────────────────────────────────────────────────
  // ── conversor de monedas (components/Conversor.js) ─────────────────────
  'fx.title': 'Conversor de monedas',
  'fx.help': 'Es solo una calculadora — no convierte tus movimientos.',
  'fx.from': 'De',
  'fx.to': 'A',
  'fx.swap': 'Invertir',
  'fx.asOf': 'Cotización del Banco Central Europeo del {d}.',
  'fx.stale': 'Sin internet — usando la cotización guardada del {d}.',
  'fx.disclaimer': 'Es tasa de referencia, publicada una vez por día hábil. Tu banco cobra otra, con spread e impuestos.',
  'fx.extraSource': 'Esta moneda no la publica el BCE — el valor sale de un promedio de mercado.',
  'fx.arsWarn': '⚠️ Acá conviven varias cotizaciones (oficial, blue, MEP). Este es un valor de mercado y puede no ser el que te da el banco o la cueva.',
  'fx.offline': 'No pude traer la cotización y no hay ninguna guardada. Conectate a internet y probá de nuevo.',

  'review.more': '+{n} grupos además de estos — categorizá los de arriba y suben',
