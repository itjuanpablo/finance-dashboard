...
export default {
  ...
  'import.dropzoneHint': 'OFX e CSV de qualquer banco · PDF dos bancos já reconhecidos',
  ...
  'import.hintPrefix': 'OFX e CSV de qualquer banco, PDF dos já reconhecidos — ou ',
  ...
  'import.err.corrupt':
    ...
    'algumas exportações de banco). Gere o PDF novamente no app ou site do banco; se ' +
    'persistir, converta para CSV (colunas: data;descricao;valor) e importe o CSV.',
  'import.err.unknownPdf':
    'Layout de PDF não reconhecido. Hoje o Fluxo lê PDF de: Nubank (extrato), Inter ' +
    '(Conta Global), Mercado Pago (extrato e fatura) e contas argentinas. Para os demais ' +
    'bancos, use OFX ou CSV — funcionam com qualquer banco e costumam trazer o sinal do ' +
  ...
  'dash.nextSteps': 'Próximos passos',
  'dash.nextStepsHelp': 'Revise o que precisa de atenção neste mês.',
  'dash.monthlyReview': 'Fechar o mês',
  'dash.monthlyReviewHelp': 'Resolva as pendências que ainda podem mudar sua visão do mês.',
  'dash.monthlyCategorize': 'Categorizar lançamentos',
  'dash.monthlyOpen': 'Revisar agora',
  'dash.monthlyClear': 'Tudo em dia neste mês.',
  ...
  'manage.accNamePh': 'Nome (ex: Conta corrente)',
  ...
  // subcategorias (ver lib/arvore-categorias.js)
  'manage.parentLabel': 'Dentro de',
  'manage.parentNone': '— categoria principal —',
  'manage.parentNotFound': 'A categoria-mãe escolhida não existe.',
  'manage.parentSelf': 'Uma categoria não pode ficar dentro dela mesma.',
  'manage.parentTooDeep': 'Só um nível: essa já está dentro de outra.',
  'manage.parentHasKids': 'Essa categoria já tem subcategorias — não pode virar subcategoria.',
  'manage.parentSystem': 'Categorias do sistema ficam fora da hierarquia.',
  'manage.subCount.one': '{n} subcategoria',
  'manage.subCount.other': '{n} subcategorias',
  'manage.catOrphaned.one': '{n} subcategoria virou categoria principal',
  'manage.catOrphaned.other': '{n} subcategorias viraram categorias principais',
  'manage.withSubs': 'inclui subcategorias',
  ...
  // quitação de fatura (ver lib/quitacao.js)
  'cards.settleManual': 'Marcar como paga',
  'cards.settleFound': 'Encontrei um pagamento que parece ser desta fatura',
  'cards.settleConfirm': 'Confirmar pagamento',
  'cards.settledOn': '{v} em {d}',
  'cards.unsettle': 'Desfazer',
  'cards.settledOk': 'Fatura marcada como paga',
  'cards.unsettledOk': 'Quitação desfeita',
  'cards.settleTxTaken': 'Esse lançamento já quita outra fatura.',
  ...
  // ── revisão em massa ───────────────────────────────────────────────────
  // ── conversor de moeda (components/Conversor.js) ───────────────────────
  'fx.title': 'Conversor de moedas',
  'fx.help': 'Só uma calculadora — não converte seus lançamentos.',
  'fx.from': 'De',
  'fx.to': 'Para',
  'fx.swap': 'Inverter',
  'fx.asOf': 'Cotação do Banco Central Europeu em {d}.',
  'fx.stale': 'Sem internet — usando a cotação guardada de {d}.',
  'fx.disclaimer': 'É taxa de referência, publicada uma vez por dia útil. Seu banco cobra outra, com spread e IOF.',
  'fx.extraSource': 'Esta moeda não é publicada pelo BCE — o valor vem de uma média de mercado.',
  'fx.arsWarn': '⚠️ Na Argentina convivem várias cotações (oficial, blue, MEP). Este é um valor de mercado e pode não ser o que o banco ou a casa de câmbio pratica.',
  'fx.offline': 'Não consegui buscar a cotação e não há nenhuma guardada. Conecte-se à internet e tente de novo.',

  'review.more': '+{n} grupos além destes — categorize os de cima e eles sobem',
  ...
  'health.title': 'Saúde financeira',
  'health.help': 'Indicadores do mês atual, com valores e pendências que merecem atenção.',
  'health.monthBalance': 'Resultado do mês',
  'health.balancePositive': 'Entradas cobrem as despesas registradas.',
  'health.balanceNegative': 'As despesas superam as entradas registradas.',
  'health.dailyBudget': 'Margem por dia',
  'health.dailyBudgetHelp': 'para os próximos {n} dias',
  'health.commitments': 'Próximas parcelas',
  'health.commitmentsHelp': '{n} parcela(s) prevista(s) em {month}',
  'health.pending': 'Pendências',
  'health.overdue': '{n} conta(s) atrasada(s)',
  'health.noOverdue': 'Sem contas atrasadas',
  'health.toReview': '{n} lançamento(s) ainda precisam de categoria.',
  'health.reviewClear': 'Nenhum lançamento aguardando revisão.',
